...
(defun color-theme-light-black ()
  ...
  (color-theme-install
   '(color-theme-light-black
     ...
     (default ((t (:stipple nil :background "Grey10" :foreground "Grey" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 87 :width semi-condensed :family "misc-fixed"))))
...
(provide 'color-theme-light-black)
